...
class opts():
  def __init__(self):
    ...
    self.parser.add_argument('-inputRes', type = int, default = 256, help = '')
    ...
    self.parser.add_argument('-numBins', type = int, default = 42, help = '')
    ...
    self.parser.add_argument('-occ', default='', type = str, help = '')
    self.parser.add_argument('-dropout', type = float, default = None, help = 'Dropout')
    self.parser.add_argument('-corruption', default=None, type = str, help = '')
    self.parser.add_argument('-nuisance', default=None, type = str, help = '')
